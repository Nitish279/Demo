...
export default function UserCard({ user }) {
  return (
    <li className="bg-purple-50 border border-purple-200 rounded-lg p-4 flex flex-col sm:flex-row sm:items-center justify-between shadow-sm hover:shadow-md transition">
      <div>
